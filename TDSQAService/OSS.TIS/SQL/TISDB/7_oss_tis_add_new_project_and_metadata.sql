...
VALUES (@newProjectId, 'SBAC Test Package XSD Project');
...
INSERT QC_ProjectMetaData (_fk_ProjectID, GroupName, VarName, IntValue, FloatValue, TextValue, Comment)
VALUES(@newProjectId, 'HandscoringTSS', 'IncludeAllDemographics', 1, NULL, NULL, 'Whether to include all student attributes and relationships in the file');

INSERT QC_ProjectMetaData (_fk_ProjectID, GroupName, VarName, IntValue, FloatValue, TextValue, Comment)
VALUES(@newProjectId, 'QA', 'MergeItemScores', 1, NULL, NULL, 'Whether to merge item scores from outside vendor into the test');

INSERT QC_ProjectMetaData (_fk_ProjectID, GroupName, VarName, IntValue, FloatValue, TextValue, Comment)
VALUES(@newProjectId, 'HandscoringTSS', 'Order', 1, NULL, '', '');

INSERT QC_ProjectMetaData (_fk_ProjectID, GroupName, VarName, IntValue, FloatValue, TextValue, Comment)
VALUES(@newProjectId, 'HandscoringTDSUnscored', 'Order', 2, NULL, '', '');
...
INSERT QC_ProjectMetaData (_fk_ProjectID, GroupName, VarName, IntValue, FloatValue, TextValue, Comment)
VALUES(@newProjectId, 'HandscoringTSS', 'Target', 1, NULL, NULL, 'Whether to send this test for item scoring');

INSERT QC_ProjectMetaData (_fk_ProjectID, GroupName, VarName, IntValue, FloatValue, TextValue, Comment)
VALUES(@newProjectId, 'HandscoringTDSUnscored', 'Target', 1, NULL, NULL, 'Whether to send this test for item scoring');

INSERT QC_ProjectMetaData (_fk_ProjectID, GroupName, VarName, IntValue, FloatValue, TextValue, Comment)
VALUES(@newProjectId, 'DW1', 'Target', 1, NULL, NULL, 'Turn send to data warehouse on/off');

INSERT QC_ProjectMetaData (_fk_ProjectID, GroupName, VarName, IntValue, FloatValue, TextValue, Comment)
VALUES(@newProjectId, 'HandscoringTSS', 'TargetType', NULL, NULL, 'WebService', 'The type of target');

INSERT QC_ProjectMetaData (_fk_ProjectID, GroupName, VarName, IntValue, FloatValue, TextValue, Comment)
VALUES(@newProjectId, 'DW1', 'TargetType', NULL, NULL, 'WebService', 'The type of target');
