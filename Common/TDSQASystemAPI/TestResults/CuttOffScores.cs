...
namespace TDSQASystemAPI.TestResults
{
    public class CutScoreStrand
    {
        ...
        internal CutScoreStrand(float cutscore, string subjectCode, string gradeCode)
        {
            _cutScore = cutscore;
            _domain = subjectCode;
        ...
        internal CutScoreStrand(string domain, double min, double max, string testName, string gradecode, string performanceLevel)
        {
            _domain = domain;
            _min = min;
            _max = max;
