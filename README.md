...
## Items/Updates included in 03/04/2015 release:

1)	TIS service was missing references to required WebAPI packages.

2)	Updated \TDSQAService\OSS.TIS\SQL\TISDB\2_Configuration.sql to include a statement to reseed CombinationTestOpportunity.OppID to 5000000.  This value should be adjusted on a case-by-case basis so as not to generate OppIds that clash with those being generated by TDS.
