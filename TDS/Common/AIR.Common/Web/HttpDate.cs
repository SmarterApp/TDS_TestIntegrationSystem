...
namespace AIR.Common.Web
{
    internal static class HttpDate
    {
        ...
        static int atoi2(string s, int startIndex)
        {
            ...
            {
                throw new FormatException(SR.GetString("Atio2BadString", s, startIndex));
            }
        }
        ...
        static int make_month(string s, int startIndex)
        {
            ...
            if (monthIndex >= 13)
            {
                ...
                {
                    throw new FormatException(SR.GetString("MakeMonthBadString", s, startIndex));
                }
            }
        ...
        static internal DateTime UtcParse(string time)
        {
            ...
            if ((i = time.IndexOf(',')) != -1)
            {
                ...
                {      /* First format */
                    ...
                    if (length < 18)
                    {
                        throw new FormatException(SR.GetString("UtilParseDateTimeBad", time));
                    }
