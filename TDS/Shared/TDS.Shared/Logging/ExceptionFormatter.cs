...
namespace TDS.Shared.Logging
{
    ...
    public abstract class ExceptionFormatter
    {
        private static readonly ArrayList IgnoredProperties = new ArrayList(
            new String[] { "Source", "Message", "HelpLink", "InnerException", "StackTrace", "Data" });
        ...
        protected virtual void WriteException(Exception exceptionToFormat, Exception outerException)
        {
            ...
            if (exceptionToFormat.Data.Count > 0)
            {
                this.WritingDataInfo(exceptionToFormat.Data);
            }
            ...
            // write sql errors if they exist
            this.WriteSqlErrors(exceptionToFormat);
        ...
        protected abstract void WriteSqlErrors(Exception exceptionToFormat);
        ...
        protected abstract void WritingDataInfo(IDictionary exceptionData);
